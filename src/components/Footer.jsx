      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-brand">
            <img src={logoImage} alt="Diva & Co." className="footer-logo" />
            <p className="footer-tagline">Crafting timeless elegance through exceptional jewelry design.</p>
          </div>
          ...
          <div className="footer-col">
            <h4>Help</h4>
            <ul>
              <li><a href="tel:+919758096789">+91 97580 96789</a></li>
          ...
          <div className="footer-col">
            ...
            <div className="footer-social">
              <a href="https://wa.me/919758096789" target="_blank" rel="noopener noreferrer" className="social-icon whatsapp" aria-label="WhatsApp">
        ...
        <div className="footer-bottom">
          <p>© 2025 Diva & Co. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
